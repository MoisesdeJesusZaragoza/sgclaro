...
<head>
    ...
    <link rel="icon" type = "image" href="/SGResident/favicon.png"> 
</head>
<body>
    <div class = "container">
        <!--nav aqui-->
    ...
    <!--scripts-->
    <?php $IPATH = $_SERVER["DOCUMENT_ROOT"]."/SGResident/cabeceras/"; include($IPATH."scripts-fin.html"); ?> <!--codigo php usado para incluir el header sin necesidad del codigo-->
</body>
</html>